...
<div class="sim-btn" style="font-size: 18px;top: 24px;">请选择模拟购买结果</div>
<div id="sim-btn0" class="sim-btn-focus" style="top: 60px">0.订购成功！</div>
<div id="sim-btn1" class="sim-btn" style="top: 100px">1.取消操作！</div>
...
<script src="{{ asset('js/hnyx/simConsume.js?v='.md5_file(public_path('js/hnyx/simConsume.js'))) }}"></script>
<script type="text/javascript">
